...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { available: @table.available, chair: @table.chair, space_id: @table.space_id } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { available: @table.available, chair: @table.chair, space_id: @table.space_id } }
